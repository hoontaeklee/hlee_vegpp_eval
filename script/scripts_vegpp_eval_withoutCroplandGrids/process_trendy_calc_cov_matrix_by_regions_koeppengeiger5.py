...
def process_trendy_members_cov_matrix_by_regions_koeppengeiger5():
    ...
    for v in range(len(list(dict_var.keys()))):
        ...
        path_trd_var = os.path.join(path_trddet, f'trendyv9_S2_{vname}-regionalMSCIAV_{vperiod}_koeppengeiger5_withoutCroplandGrids.nc')
        ...
        np.savez(
                os.path.join(path_trddet, 'cov_norm', f'koeppengeiger5_region_cov_norm_{vname}_{vperiod}_EnsMedian_withoutCroplandGrids.npz'),
        ...
        np.savez(
            os.path.join(path_trddet, 'cov_norm', f'koeppengeiger5_region_cov_norm_{vname}_{vperiod}_members_withoutCroplandGrids.npz'),
