...
def plot_fig04_gpp_msc_by_regions(path_expOutput):
    ...
    path_flx = os.path.join(path_bgi, 'people/hlee/data/FLUXCOM/members_detrended/region_koeppengeiger5')
    ds_flx_reg = xr.open_dataset(os.path.join(path_flx, 'GPP_RS_METEO-NONE_Koeppengeiger5Regions_2002-2015_studyArea_members.nc'))
    ...
    ds_trd_reg = xr.open_dataset(os.path.join(path_trendy, 'trendyv9_S2_gpp-regionalMSCIAV_2002-2015_koeppengeiger5.nc'))
    ...
    fig.text(-0.16, 0.15, r'GPP', va='center', rotation='vertical', fontsize=fsize_suplab)
    ...
    axes[0].legend(
                ...
                loc='upper center', bbox_to_anchor=(0.47, 1.14), bbox_transform=fig.transFigure,
    ...
    fig.savefig(
        os.path.join(path_out, f"fig_gpp_msc_by_regions_kg5.png"),
        dpi=600,
        transparent=False,
        bbox_inches='tight'
    )
