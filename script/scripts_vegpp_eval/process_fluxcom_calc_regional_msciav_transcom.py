...
path_out = os.path.join(path_bgi, 'people/hlee/data/FLUXCOM/members_detrended/region_transcom')
...
rcnt = 11  # transcom 11; bioclimatic 11
for v in range(len(list(dict_src.keys()))):
    ...
    ds_tc_aggr.to_netcdf(os.path.join(path_out, f'{vname}_RS_METEO-NONE_TranscomRegions_{date_label}_studyArea_members.nc'))
    ...
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_TranscomRegions_{date_label}_studyArea_det_fromRunningMean.nc'))
    ...
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_TranscomRegions_{date_label}_studyArea_det_fromRunningMean.nc'))
    ...
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_TranscomRegions_{date_label}_studyArea_msc.nc'))
    ...
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_TranscomRegions_{date_label}_studyArea_msc.nc'))
    ...
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_msc.nc'))
    ...
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_msc.nc'))
    ...
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_det_fromTranscomRegions_fromRunningMean.nc'))
    ...
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_det_fromTranscomRegions_fromRunningMean.nc'))