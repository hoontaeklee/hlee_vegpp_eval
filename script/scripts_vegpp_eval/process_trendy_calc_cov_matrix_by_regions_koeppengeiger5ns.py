...
def process_trendy_members_cov_matrix_by_regions_koeppengeiger5ns():
    '''
    '''
    ...
    path_trddet = os.path.join(path_bgi, 'people/hlee/data/trendy/v9/regridded_1deg/detrended')
    ...
    for v in range(len(list(dict_var.keys()))):
        ...
        path_trd_var = os.path.join(path_trddet, f'trendyv9_S2_{vname}-regionalMSCIAV_{vperiod}_koeppengeiger5ns.nc')
        ...
        np.savez(
                os.path.join(path_trddet, 'cov_norm', f'koeppengeiger5ns_region_cov_norm_{vname}_{vperiod}_EnsMedian.npz'),
        ...
        np.savez(
            os.path.join(path_trddet, 'cov_norm', f'koeppengeiger5ns_region_cov_norm_{vname}_{vperiod}_members.npz'),
...
if __name__ == '__main__':
    process_trendy_members_cov_matrix_by_regions_koeppengeiger5ns()