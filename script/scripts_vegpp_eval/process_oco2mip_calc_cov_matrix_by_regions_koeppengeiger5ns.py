...
def process_oco2inv_members_cov_matrix_by_regions_koeppengeiger5ns():
    '''
    '''
    ...
    path_oco2median_msc = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_msc.nc')
    path_oco2median_det = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_det_fromRunningMean.nc')
    ...
    np.savez(
            os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5ns_region_cov_norm_EnsMedian.npz'),
    ...
    np.savez(
        os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5ns_region_cov_norm_members.npz'),
        ar_cov_msc=ar_cov_norm_msc_mem_stack,
        ar_cov_det=ar_cov_norm_det_mem_stack
    )

if __name__ == '__main__':
    process_oco2inv_members_cov_matrix_by_regions_koeppengeiger5ns()