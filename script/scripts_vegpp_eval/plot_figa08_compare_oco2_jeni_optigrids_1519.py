...
fig.text(-0.07, 0.5, 'NEE (gC m-2 day-1)', va='center', rotation='vertical', fontsize=fsize_suplab)

fig.subplots_adjust(top=0.98, bottom=0.02, left=0.02, right=0.98,
                    wspace=0.23, hspace=0.45)
fig.savefig(
    '/Net/Groups/BGI/people/hlee/hlee_vegpp_eval/figures_revision1/figa09_compare_oco2_jeni_optigrids_1519.png',
    dpi=600,
    transparent=False,
    bbox_inches='tight'
)
