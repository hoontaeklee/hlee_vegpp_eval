...
def plot_vegpp_by_regions_with_trendy_nee_iav(path_expOutput):
    ...
    # path_expOutput = os.path.join(path_bgi, 'people/hlee/sindbad/data/output/VEGPP2pool1519_studyArea_10k_RD4wtnanmean_esviav_1_20240503/detrended')
    ...
    fig.savefig(
        os.path.join(path_out, f"fig06_nee_iav_by_regions.png"),
        dpi=600,
        transparent=False,
        bbox_inches='tight'
    )
