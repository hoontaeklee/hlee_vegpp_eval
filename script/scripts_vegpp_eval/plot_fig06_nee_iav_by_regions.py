...
def plot_vegpp_by_regions_with_trendy_nee_iav(path_expOutput):
    ...
    # path_expOutput = os.path.join(path_bgi, 'people/hlee/sindbad/data/output/VEGPP2pool1519gppActmin_studyArea_10k_1_20250104/detrended')
    ...
    for i in range(len(list_var)):
        ...
        ax_y2.spines["left"].set_position(("axes", -0.18)) # green one
    ...
    fig.text(0.5, -0.08, 'Time', ha='center', fontsize=fsize_suplab)
    ...
    fig.savefig(
        os.path.join(path_out, f"fig06_nee_iav_by_regions_{exp_name_date}.png"),
        dpi=600,
        transparent=False,
        bbox_inches='tight'
    )
