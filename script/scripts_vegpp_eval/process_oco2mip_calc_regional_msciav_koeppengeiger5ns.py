...
area_tc = apply_koeppengeiger5ns_mask(
    ...
    varlf='landfraction',
    faclf='1.0',
    path_rm='/Net/Groups/BGI/people/hlee/data/koeppengeiger/kg5ns_regions_oneDeg.nc',
    func_aggr='sum',
    tosave=False,
    toplot=False
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_unc.attrs['description'] = 'mean absolute deviation for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_msc.nc'))
...
ds_med.attrs['description'] = 'median for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_msc.nc'))
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_msc.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_msc.nc'))
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5nsRegions_2015_2019_studyArea_det_fromRunningMean.nc'))