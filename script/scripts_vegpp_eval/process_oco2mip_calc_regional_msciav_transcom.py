'''
- calculate the uncertainty of oco2 ensemble across transcom regions
...
net_iav_stack_regions = np.ones((len(files), 11, nmonths)) * np.nan  # (member, region, time)
net_msc_stack_regions = np.ones((len(files), 11, nmonths)) * np.nan  # (member, region, time)
...
# # exclude 0.5% outliers from each tail  <-- already applied above during regional aggregation by apply_transcom_mask()
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_unc.attrs['description'] = 'mean absolute deviation for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_msc.nc'))
...
ds_med.attrs['description'] = 'median for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_msc.nc'))
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_msc.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_msc.nc'))
...
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det_fromRunningMean.nc'))