...
def plot_fig09_iav_contrib_by_regions_koeppengeiger5(path_expOutput):
    ...
    # the ensemble median
    path_npz_med_oco2 = os.path.join(path_oco2, 'koeppengeiger5_region_cov_norm_EnsMedian.npz')
    ar_cov_nee_det_kg_med_oco2 = np.load(path_npz_med_oco2)['ar_cov_det']

    # members
    path_npz_mem_oco2 = os.path.join(path_oco2, 'koeppengeiger5_region_cov_norm_members.npz')
    ...
    # plt.plot(np.arange(5), ar_cov_var_nee_det_kg_mem_sin, 'o-', label='var')
    # plt.plot(np.arange(5), ar_cov_cov_nee_det_kg_mem_sin, 'o-', label='cov')
    # plt.plot(np.arange(5), ar_cov_nee_det_kg_mem_sin, 'o-', label='var+cov')
    # plt.legend()
    # plt.xticks(np.arange(5), rnames_short, rotation=30)
    # plt.ylim(-0.25, 0.85)
    ...
    path_npz_med_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_nee_2015-2019_EnsMedian.npz')
    ...
    path_npz_mem_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_nee_2015-2019_members.npz')
    ...
    save_name = os.path.join(path_out, f"fig09_cov_iav_region_koeppengeiger5.png")
    fig.savefig(
        save_name,
        dpi=600,
        bbox_inches='tight',
