...
def process_fluxcom_calc_cov_matrix_by_regions_koeppengeiger5():
    ...
    path_median_msc = os.path.join(path_det_ens, f'EnsMedian_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_2002-2015_studyArea_msc.nc')
    path_median_det = os.path.join(path_det_ens, f'EnsMedian_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_2002-2015_studyArea_det_fromRunningMean.nc')
    ...
    np.savez(
            os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_EnsMedian_withoutDeforestedGrids.npz'),
    ...
    for f in range(nmembers):
        ...
        ds_det_msk = ds_det.where(~ds_fcc.treecoverchange)
        ...
        np.savez(
            os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_{membername}_withoutDeforestedGrids.npz'),
    ...
    np.savez(
        os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_members_withoutDeforestedGrids.npz'),
