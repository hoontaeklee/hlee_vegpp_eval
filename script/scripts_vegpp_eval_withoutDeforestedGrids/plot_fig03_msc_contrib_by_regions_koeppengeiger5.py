...
def plot_fig08_msc_contrib_by_regions_koeppengeiger5(path_expOutput):
    ...
    # the ensemble median
    path_npz_med_flx = os.path.join(path_flx, 'koeppengeiger5_region_cov_norm_GPP_EnsMedian_withoutDeforestedGrids.npz')
    ar_cov_gpp_msc_kg_med_flx = np.load(path_npz_med_flx)['ar_cov_msc']

    # members
    path_npz_mem_flx = os.path.join(path_flx, 'koeppengeiger5_region_cov_norm_GPP_members_withoutDeforestedGrids.npz')
    ...
    save_name = os.path.join(path_out, f"fig08_cov_msc_region_koeppengeiger5_wihtoutDeforestedGrids.png")
    fig.savefig(
        save_name,
        dpi=600,
        bbox_inches='tight',
