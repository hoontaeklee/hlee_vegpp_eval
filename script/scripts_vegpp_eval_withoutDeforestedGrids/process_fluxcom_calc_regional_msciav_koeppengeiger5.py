...
path_out = os.path.join(path_bgi, 'people/hlee/data/FLUXCOM/members_detrended/region_koeppengeiger5')
...
rcnt = 5  # transcom 11; bioclimatic 11; trautmann 5; koeppengeiger 8
for v in range(len(list(dict_src.keys()))):
    ...
    ds_tc_aggr.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_tc_aggr.to_netcdf(os.path.join(path_out, f'{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_members.nc'))
    ...
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_det_fromRunningMean.nc'))
    ...
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_det_fromRunningMean.nc'))
    ...
    ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_msc.nc'))
    ...
    ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_msc.nc'))
    ...
    ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_global_mean_fluxes_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_msc.nc'))
    ...
    ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_global_mean_fluxes_Koeppengeiger5Regions_withoutDeforestedGrids_{date_label}_studyArea_msc.nc'))
    ...
    ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_unc.to_netcdf(os.path.join(path_out, f'EnsMAD_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_det_fromKoeppengeiger5Regions_withoutDeforestedGrids_fromRunningMean.nc'))
    ...
    ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
    ds_med.to_netcdf(os.path.join(path_out, f'EnsMedian_{vname}_RS_METEO-NONE_global_mean_fluxes_{date_label}_studyArea_det_fromKoeppengeiger5Regions_withoutDeforestedGrids_fromRunningMean.nc'))