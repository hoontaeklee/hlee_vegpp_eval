...
path_fcc = '/Net/Groups/BGI/people/hlee/data/hansen_forest_cover/treecover/treecover.2001-2019.180.360.nc'
...
period_fcc = path_fcc.split('/')[-1].split('.')[1]
...
area_msk = np.where(ar_fcc, np.nan, area_msk)
...
lf_msk = np.where(ar_fcc, np.nan, lf_msk)
...
mask_to_use = da_common_nonnan * ~ds_fcc.treecoverchange
...
ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_det_fromRunningMean.nc'))
...
# ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det.nc'))
...
# ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_TranscomRegions_2015_2019_studyArea_det.nc'))
...
ds_unc.attrs['description'] = 'mean absolute deviation for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_msc.nc'))
...
ds_med.attrs['description'] = 'median for each region and timestep calculated over area-weighted mean regional time series of ensemble members; for each timestep, 0.5p of each tail was excluded from calculating the regional mean time series'
ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_msc.nc'))
...
# ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_2015_2019_studyArea_det.nc'))
...
# ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_2015_2019_studyArea_det.nc'))
...
ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_msc.nc'))
...
ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_msc.nc'))
...
ds_unc.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_unc.to_netcdf(os.path.join(path_out, 'EnsMAD_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_det_fromRunningMean.nc'))
...
ds_med.attrs['deforestation'] = f'remove top-{p_threshold} percentile severely deforested grid cells during {period_fcc}'
ds_med.to_netcdf(os.path.join(path_out, 'EnsMedian_global_mean_fluxes_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_det_fromRunningMean.nc'))