...
def plot_fig09_iav_contrib_by_regions_koeppengeiger5(path_expOutput):
    ...
    # the ensemble median
    path_npz_med_oco2 = os.path.join(path_oco2, 'koeppengeiger5_region_cov_norm_EnsMedian_withoutDeforestedGrids.npz')
    ar_cov_nee_det_kg_med_oco2 = np.load(path_npz_med_oco2)['ar_cov_det']

    # members
    path_npz_mem_oco2 = os.path.join(path_oco2, 'koeppengeiger5_region_cov_norm_members_withoutDeforestedGrids.npz')
    ...
    path_npz_mem_sin = os.path.join(path_expOutput, 'koeppengeiger5_region_cov_norm_gpp_withoutDeforestedGrids.npz')
    ar_cov_gpp_det_kg_mem_sin = np.load(path_npz_mem_sin)['ar_cov_det_sin']

    path_npz_mem_sin = os.path.join(path_expOutput, 'koeppengeiger5_region_cov_norm_cRECO_withoutDeforestedGrids.npz')
    ar_cov_reco_det_kg_mem_sin = np.load(path_npz_mem_sin)['ar_cov_det_sin']

    path_npz_mem_sin = os.path.join(path_expOutput, 'koeppengeiger5_region_cov_norm_NEE_withoutDeforestedGrids.npz')
    ...
    # the ensemble median
    path_npz_med_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_gpp_2002-2015_EnsMedian_withoutDeforestedGrids.npz')
    ar_cov_gpp_det_kg_med_trd = np.load(path_npz_med_trd)['ar_cov_det']

    path_npz_med_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_reco_2002-2015_EnsMedian_withoutDeforestedGrids.npz')
    ar_cov_reco_det_kg_med_trd = np.load(path_npz_med_trd)['ar_cov_det']

    path_npz_med_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_nee_2015-2019_EnsMedian_withoutDeforestedGrids.npz')
    ar_cov_nee_det_kg_med_trd = np.load(path_npz_med_trd)['ar_cov_det']

    # members
    idx_model2exclude = [6, 7, 9]
    path_npz_mem_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_gpp_2002-2015_members_withoutDeforestedGrids.npz')
    ...
    path_npz_mem_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_reco_2002-2015_members_withoutDeforestedGrids.npz')
    ...
    path_npz_mem_trd = os.path.join(path_trd, 'koeppengeiger5_region_cov_norm_nee_2015-2019_members_withoutDeforestedGrids.npz')
    ...
    path_out = os.path.join(path_bgi, 'people/hlee/hlee_vegpp_eval_withoutDeforestedGrids/figures_revision1')
    save_name = os.path.join(path_out, f"fig09_cov_iav_region_koeppengeiger5_wihtoutDeforestedGrids.png")
    fig.savefig(
        save_name,
        dpi=600,
        bbox_inches='tight',
