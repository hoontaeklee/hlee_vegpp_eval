...
def process_oco2inv_members_cov_matrix_by_regions_koeppengeiger5():
    ...
    path_oco2median_msc = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_msc.nc')
    path_oco2median_det = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_GFED4FireRemoved_Koeppengeiger5Regions_withoutDeforestedGrids_2015_2019_studyArea_det_fromRunningMean.nc')
    ...
    np.savez(
            os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5_region_cov_norm_EnsMedian_withoutDeforestedGrids.npz'),
    ...
    np.savez(
        os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5_region_cov_norm_members_withoutDeforestedGrids.npz'),
