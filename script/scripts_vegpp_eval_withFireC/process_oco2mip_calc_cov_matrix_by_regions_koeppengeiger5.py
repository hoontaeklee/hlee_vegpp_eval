...
def process_oco2inv_members_cov_matrix_by_regions_koeppengeiger5():
    ...
    path_oco2median_msc = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_Koeppengeiger5Regions_2015_2019_studyArea_msc.nc')
    path_oco2median_det = os.path.join(path_oco2det, 'EnsMedian_LNLGIS_Koeppengeiger5Regions_2015_2019_studyArea_det_fromRunningMean.nc')
    ...
    np.savez(
            os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5_region_cov_norm_EnsMedian_withFireC.npz'),
    ...
    list_files_det = [f for f in list_files_det if not f.__contains__('GFED')]
    list_files_det.sort()
    ...
    np.savez(
        os.path.join(path_oco2det, 'cov_norm', f'koeppengeiger5_region_cov_norm_members_withFireC.npz'),
