...
def process_fluxcom_calc_cov_matrix_by_regions_koeppengeiger5():
    ...
    np.savez(
            os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_EnsMedian.npz'),
    ...
    for f in range(nmembers):
        ...
        np.savez(
            os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_{membername}.npz'),
    ...
    np.savez(
        os.path.join(path_out, f'koeppengeiger5_region_cov_norm_{vname}_members.npz'),
