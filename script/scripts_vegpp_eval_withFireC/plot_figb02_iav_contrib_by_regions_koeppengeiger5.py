...
def plot_fig09_iav_contrib_by_regions_koeppengeiger5(path_expOutput):
    ...
    path_out = os.path.join(path_bgi, 'people/hlee/hlee_vegpp_eval_withFireC/figures_revision1')
    save_name = os.path.join(path_out, f"fig09_cov_iav_region_koeppengeiger5_withFireC.png")
    fig.savefig(
        save_name,
        dpi=600,
        bbox_inches='tight',
